...
public class InboxConfiguration {
    ...
    public void configure() {
        ...
        Repository<Mail> messageRepository = singularity.createRepository(Mail.class);
        ...
        SecuredRepository<Mail> securedMailRepository = (SecuredRepository<Mail>) securityManager.getRepository(Mail.class.getSimpleName(),
            UserId.forUUID(userJohn.getId()));
        ...
        ActionsRepository.actionsRepository().addActions(new MailActions(securedMailRepository, clientRepository));

        actionsRepository = ActionsRepository.actionsRepository();
    }
